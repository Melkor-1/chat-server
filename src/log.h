...
/** 
*	\brief	log_msg() writes msg to stream in the ISO 8601 format:
*			"03-02-16T10:05:41, msg", if msg is not NULL. If stream is NULL,
...
*/
int log_msg (FILE *stream, const char *msg, unsigned options);
